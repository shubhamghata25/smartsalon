    ...
    <div className="min-h-screen pt-[70px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mt-12 glass-card rounded-sm overflow-hidden" style={{ height: 380 }}>
          <iframe
            src={process.env.NEXT_PUBLIC_MAPS_EMBED_URL || "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d241317.11609823057!2d72.74110225661934!3d19.08219783956771!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c6306644edc1%3A0x5da4ed8f8d648c69!2sMumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1234567890"}
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
